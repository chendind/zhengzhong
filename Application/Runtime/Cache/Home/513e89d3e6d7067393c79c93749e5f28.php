...
<head>
	...
	<script src="/tp/Public/js/login.js"></script>
</head>
<body>
	<div class="title">asign page</div>
	<div class="content">
		<div class="webinput"><input id="phoneNum" type="text" placeholder="phone num"></div>
		<div class="webinput">
			<input id="chkCode" type="text" placeholder="security code">
